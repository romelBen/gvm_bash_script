...
This installs Greenbone Vulnerability Management (GVM) as a bash script for Debian/Ubuntu services. This does NOT work for Docker. Please bare that in mind it works for VMs and bare metal deployments.
